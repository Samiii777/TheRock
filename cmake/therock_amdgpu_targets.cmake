...
therock_add_amdgpu_target(gfx1103 "AMD Radeon 780M Laptop iGPU" FAMILY igpu-all gfx110X-all gfx110X-igpu
  EXCLUDE_TARGET_PROJECTS
    hipSPARSELt # https://github.com/ROCm/TheRock/issues/2042
    # composable_kernel: gfx1103 (RDNA3 Phoenix) is CK-capable (same WMMA ISA as
    # gfx1100/1101/1102, which are NOT excluded from composable_kernel). Excluding
    # CK only for gfx1103 while it stays enabled for the rest of the gfx110X-all
    # family left MIOpen without libMIOpenCKGroupedConv_gfx1103.so, so grouped/
    # depthwise conv found no working solver at runtime -> GPU hang.
    # See https://github.com/ROCm/TheRock/issues/6252 (was #4836)
    hipTensor # https://github.com/ROCm/TheRock/issues/2074
