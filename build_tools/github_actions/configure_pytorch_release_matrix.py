...
PYTORCH_REFS_LINUX: list[dict] = [
    ...
    },
    {
        ...
        # gfx125x not yet upstreamed to pytorch/pytorch; release/2.11's vendored
        # Composable Kernel does not support gfx1250 (CK_BUFFER_RESOURCE_3RD_DWORD
        # is undefined for that arch).
